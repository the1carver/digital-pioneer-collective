...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Navigation - Updated to use auth-aware Navigation component */}
      <Navigation />
      ...
      <section className="relative py-24 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <h1 className="enhanced-title text-5xl md:text-7xl font-bold mb-6">Marketing Belongs to the Makers.</h1>
      ...
      <section className="py-20 px-4 bg-card/50">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="enhanced-title-h2 text-4xl font-bold mb-8">The Old Map is Broken</h2>
          ...
          <div className="enhanced-title-h2 text-2xl font-semibold text-primary">We're drawing a new map.</div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="enhanced-title-h2 text-4xl font-bold mb-6">What is the Digital Pioneers Collective?</h2>
      ...
      <section className="py-20 px-4 bg-card/50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="enhanced-title-h2 text-4xl font-bold mb-6">How It Works: The Flywheel of Value</h2>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <h2 className="enhanced-title-h2 text-4xl font-bold mb-6">Our AI Assistant: Your Transparent Co-Pilot</h2>
      ...
      <section className="py-20 px-4 bg-card/50">
        <div className="container mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="enhanced-title-h2 text-4xl font-bold mb-6">Own Your Audience. Fund Your Vision.</h2>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="enhanced-title-h2 text-4xl font-bold mb-6">Market with Culture, Not Just Ads.</h2>
              <p className="text-lg text-muted-foreground mb-8">
      ...
      <section className="py-20 px-4 bg-card/50">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="enhanced-title-h2 text-4xl font-bold mb-12">Our Manifesto: The Pioneer's Code</h2>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="enhanced-title-h2 text-4xl font-bold mb-6">Join the Frontier</h2>
